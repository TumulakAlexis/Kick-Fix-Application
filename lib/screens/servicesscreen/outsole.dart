...
class OutsoleForm extends StatefulWidget {
  const OutsoleForm({Key? key}) : super(key: key);

  @override
  State<OutsoleForm> createState() => _OutsoleFormState();
}

class _OutsoleFormState extends State<OutsoleForm> {
  ...
  Future<void> _submitForm() async {
    try {
      await FirebaseFirestore.instance.collection('cleaning_forms').add({
        'Service': 'Outsole Repair Service',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Outsole Repair Form'),
      ),
